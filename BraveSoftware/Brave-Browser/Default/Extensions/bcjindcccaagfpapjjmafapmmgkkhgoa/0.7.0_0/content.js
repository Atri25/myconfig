  ...
  var resultPromise = (async () => {
    ...
    document.body.appendChild(rawJsonContainer);
    {
      ...
      const parsedJsonRootStruct = parsedJsonValue;
      {
        ...
        jfStyleEl.insertAdjacentHTML("beforeend", style_default);
