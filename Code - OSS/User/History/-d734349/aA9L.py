...
Drag mouse = [ Drag([mod], "control", lazy.window.set_position_floating(), start=lazy.window.get_position()), Drag([mod], "shift", lazy.window.set_size_floating(), start=lazy.window.get_size()), Click([mod])]
