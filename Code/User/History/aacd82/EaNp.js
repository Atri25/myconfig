...
const home = () => (
    ...
    <p className="lead">Blogging is a form of sharing information with the world and i have build this website so that people like I can share what I feel and you can enjoy coneuming my content</p>
    <hr className="my-4"/>
